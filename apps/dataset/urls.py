...
urlpatterns = [
    ...
    path('dataset/<str:dataset_id>/members/put_permissions', views.Dataset.PutMemberPermissions.as_view()),
    ...
    path('dataset/external_api/cnki_full_doc', views.CNKIAllFulltextView.as_view(), name="CNKI Full 文献"),
]
