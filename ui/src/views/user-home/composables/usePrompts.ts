...
- **正文引用**：必须在引用的观点或数据后进行标注，确保观点可溯源。
  ...
  - **禁止匿名引用**：严禁出现“佚名”、“不知道作者”、“Unknown”等引用标记。如果作者未知，请直接引用文章标题或省略该引用。
- **参考文献**：
  - 在文章末尾列出所有引用的文献。
